...
/* Sidebar headshot */
.ah-headshot-wrap { display: flex; justify-content: center; margin-top: 0.25rem; margin-bottom: 0.75rem; }
.ah-headshot-wrap img { border-radius: 999px; border: 1px solid rgba(17,24,39,0.12); }
</style>
        """,
...
with st.sidebar:
    try:
        ...
        # If the image is missing in some environment, keep the app usable.
        pass
...
st.markdown("**MSBA Graduate, University of Washington**")
st.write(
    "A curated set of portfolio-grade analytics applications across forecasting, experimentation, pricing, data systems, and GenAI."
)
